  ...
  <div class="container">
    <div class="lead-grid">
      <div class="lead-copy">
        ...
        <p class="meta meta-tight">Dancer 2024&ndash;2026 &middot; Kathak Captain 2026&ndash;Present &middot; Competitive Indian Classical Dance Team</p>
        ...
        <div class="metrics">
          ...
          <div><strong>Top 8</strong><span>at Origins, the national collegiate Indian classical dance championship</span></div>
        </div>
      </div>
      <div>
        <ul class="lead-list">
          <li><b>Creative Direction</b>: develop the theme and artistic direction for our competition piece, including choreography, storytelling, formations, and costume design.</li>
          <li><b>Team Leadership</b>: lead rehearsals, teach choreography, organize tryouts and recruitment, and guide the team through preparation for the collegiate competition season.</li>
        </ul>
        <div class="lead-photos">
